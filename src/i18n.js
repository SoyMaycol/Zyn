...
const STRINGS = {
  en: {
    ...
    compactCommand: 'Memory compacted using {mode} mode.',
    compactUsage: 'Usage: /compact low|medium|high',
    compactInvalid: 'Invalid compaction mode. Available: low, medium, high',
    compactWarningHigh: 'High compaction may remove secondary details. Continue?',
    compactPromptTitle: 'High compaction confirmation',
    compactDone: 'Memory compacted.',
    compactNoChange: 'No memory changes were needed.',
  ...
  es: {
    ...
    compactCommand: 'Memoria compactada usando modo {mode}.',
    compactUsage: 'Uso: /compact low|medium|high',
    compactInvalid: 'Modo de compactación no válido. Disponibles: low, medium, high',
    compactWarningHigh: 'La compactación alta puede eliminar detalles secundarios. ¿Continuar?',
    compactPromptTitle: 'Confirmación de compactación alta',
    compactDone: 'Memoria compactada.',
    compactNoChange: 'No se necesitaban cambios en la memoria.',
    sessionLabel: 'sesión',
    titleLabel: 'título',
    modelLabel: 'modelo',
    cwdLabel: 'cwd',
